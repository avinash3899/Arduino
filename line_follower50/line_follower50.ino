...
if((currentERROR>=-3.5&&currentERROR<-1)||(currentERROR>1&&currentERROR<=3.5))
{
  RIGHTSPEED = 150;
  LEFTSPEED = 150;
  calculatepid();
...
void brake(){
 ...
 /*   void correct_destablize_left(){
      
    }
        void correct_destablize_right(){
