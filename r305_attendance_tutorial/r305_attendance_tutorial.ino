...
#define Finger_Rx D3 //D5
#define Finger_Tx D4 //D6
...
const char *ssid = "Avinash";  //ENTER YOUR WIFI SETTINGS
const char *password = "password";
//************************************************************************
String postData ; // post array that will be send to the website
String link = "http://192.168.43.95/biometricattendance/getdata.php"; //computer IP or the server domain
